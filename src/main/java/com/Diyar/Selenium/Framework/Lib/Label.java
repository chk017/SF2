...
public class Label extends SimpleLib{
	...
	public String getattribute(String sAttributeName) {
		...
		case ID:
			sAttributeValue = getDriver().findElement(By.id(sElement)).getAttribute(sAttributeName); break;
		case NAME:
			sAttributeValue = getDriver().findElement(By.name(sElement)).getAttribute(sAttributeName); break;
		case XPATH:
			waitForElement(sAttributeValue);
			sAttributeValue = getDriver().findElement(By.xpath(sElement)).getAttribute(sAttributeName); break;
		case CSS:
			sAttributeValue = getDriver().findElement(By.cssSelector(sElement)).getAttribute(sAttributeName); break;
		}
